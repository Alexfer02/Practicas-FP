...
public class TestTrayectoTren {
	...
	public static void main(String[] args) {
		...
		tt.anadirEstacionIntermedia(2, "VILLANUEVA DE CORDOBA-LOS PEDROCHES", LocalTime.of(8,13), LocalTime.of(8,14));
		System.out.println(tt);

		tt.anadirEstacionIntermedia(4, "CIUDAD REAL", LocalTime.of(8,57), LocalTime.of(8,58));
		System.out.println(tt);
